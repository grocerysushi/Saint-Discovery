...
export default async function ConfirmationSaintGuide() {
  ...
  return <main className="site-width guide-page">
    ...
    <aside className="educator-guide-note">Leading a Confirmation group? <Link href="/resources/teachers">Get the free lesson plan and printable saint-reflection worksheet <span aria-hidden>↗</span></Link></aside>
