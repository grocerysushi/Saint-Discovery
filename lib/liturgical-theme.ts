...
const LITURGICAL_THEMES: Record<LiturgicalColor, LiturgicalThemeDefinition> = {
  white: {
    ...
    cssVars: {
      "--color-navy": "#161f26",
      "--color-navy-light": "#202d35",
      "--color-navy-lighter": "#38454e",
      "--color-gold": "#f1e5cf",
  ...
  red: {
    ...
    cssVars: {
      "--color-navy": "#20171d",
      "--color-navy-light": "#2d222a",
      "--color-navy-lighter": "#48343f",
      "--color-gold": "#ec9b98",
      "--color-gold-light": "#ffd0c7",
      "--color-cream": "#f7ede8",
  ...
  green: {
    ...
    cssVars: {
      "--color-navy": "#111b21",
      "--color-navy-light": "#19272e",
      "--color-navy-lighter": "#324149",
      "--color-gold": "#becda6",
      "--color-gold-light": "#e0e9cd",
      "--color-cream": "#f6f4ed",
      "--color-cream-dark": "#c6cece",
    } as CSSProperties,
  },
  violet: {
    color: "violet",
    ...
    cssVars: {
      "--color-navy": "#1c1828",
      "--color-navy-light": "#292339",
      "--color-navy-lighter": "#44384f",
      "--color-gold": "#c7b0e9",
      "--color-gold-light": "#e4d2fa",
      "--color-cream": "#f2edf7",
